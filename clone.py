...
#                text_look = f'{str(key_year) + str(month) + str(special_key_date) + str(key_time)}'
                text_look = f'{str(key_year) + str(month) + str(special_key_date)}'
                # debug(text_look)
                ...
                if file_pattern:
                    ...
                    call_rsync_cmd = 'rsync -zvh --progress --remove-source-files --progress ' + ftp_dir + str(file_string_name2) + ' ' + str(long_storage) + str(key_year) + '/' + str(month) + '/'
